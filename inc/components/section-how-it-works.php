<section class="background--black py-0 mb-5">
  <div class="outer-container background--light-grey">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="bold style--yellow-bar">How it works</h2>
          <p class="color--secondary">We know that when you’ve got bills to pay, you don’t have time to waste. With MyBorrowing’s short and easy online application, you can apply for a loan from any device! The form should take only a few minutes to complete and as soon as you hit submit we’ll get to work on your assessment. </p>
        </div>
      </div>
