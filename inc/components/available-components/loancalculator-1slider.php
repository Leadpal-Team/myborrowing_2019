<form id="loan-calculator" class="app-form loan-calculator  my-md-2 mx-sm-0 my-sm-0 mx-lg-4 my-lg-4" autocomplete="on" oninput="formUpdate()" method="GET" action="<?php echo APPLICATION_URL ?>">
	...
	<div class="row">
		...
		<div class="col-12">
			<div class="slider-tooltip text-center" id="loan-amount-bubble"><p id="loan-amount-tooltip"><?php echo LOAN_CURRENCY_UNIT . number_format(LOAN_AMOUNT_DEFAULT_VALUE); ?></p></div>
			<input type="range" name="loan_amount" aria-label="Loan Amount" id="loan-amount" value="<?php echo LOAN_AMOUNT_DEFAULT_VALUE ?>" min="<?php echo SACC_LOAN_MIN; ?>" max="<?php echo SACC_LOAN_MAX; ?>" step="<?php echo LOAN_AMOUNT_STEP; ?>">
		</div>
		<div class="col-12 d-flex justify-content-between">
			<p class="d-inline"><?php echo LOAN_CURRENCY_UNIT . number_format(SACC_LOAN_MIN); ?></p>
			<p class="d-inline"><?php echo LOAN_CURRENCY_UNIT . number_format(SACC_LOAN_MAX); ?></p>
		</div>
	</div>
