...
<nav class="navbar navbar-expand-lg py-4">
	<div class="container d-flex flex-row justify-content-between">
		<a class="nav-logo" href="<?php echo get_site_url(); ?>"><img src="<?php echo DIRECTORY; ?>/assets/images/logo.png" class="img-fluid"></a>
...
<div id="sidenav" class="sidenav text-center background--white">
	<img src="<?php echo DIRECTORY; ?>/assets/images/logo-alt.png" class="img-fluid mt-5 px-2">
	<ul class="pl-0">
