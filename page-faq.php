      ...
      <div class="row accordion mt-lg-5">
        ...
        <div aria-controls="faq-default-0" aria-expanded="false" class="px-4 accordion-header collapsed" data-target="#faq-default-0" data-toggle="collapse" id="faq-default-0-heading">
				...
				<div aria-labelledby="faq-default-0-heading" class="collapse" data-parent=".accordion" id="faq-default-0" style="">
					<div class="card-body text-left pt-0">
					  <p class="accordion-content mb-0 ">Essentially, we do the searching so you don’t have to! When you apply with MyBorrowing we will find the best loan option to meet your needs. Once we’ve found it, we’ll put you directly in touch with the lender who can offer you the loan you’re looking for.</p>
					</div>
				</div>	
			</div>				
        ...
        <div aria-controls="faq-default-2" aria-expanded="false" class=" collapsed px-4 accordion-header" data-target="#faq-default-2" data-toggle="collapse" id="faq-default-2-heading">
				...
				<div aria-labelledby="faq-default-2-heading" class="collapse" data-parent=".accordion" id="faq-default-2">
					<div class="card-body text-left pt-0">
					<p class="accordion-content mb-0 ">Once MyBorrowing has reviewed your application we will match you to a suitable lender. Then, you will have to wait for final approval of your application. If successful, the money will be transferred straight into your bank account subject to the lenders protocol. </p>
					</div>
				</div>	
			</div>				
        ...
        <div aria-controls="faq-default-3" aria-expanded="false" class=" collapsed px-4 accordion-header" data-target="#faq-default-3" data-toggle="collapse" id="faq-default-3-heading">
				...
				<div aria-labelledby="faq-default-3-heading" class="collapse" data-parent=".accordion" id="faq-default-3">
					<div class="card-body text-left pt-0">
					<p class="accordion-content">The cost of your loan depends on the lender. We encourage all our lenders to be upfront with all fees and charges associated with their loans. Unless your lender says otherwise, you can expect to pay something similar to this:</p>
